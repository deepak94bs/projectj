<%-- 
    Document   : manager
    Created on : Jul 3, 2015, 12:42:45 AM
  ...
  <div id="main">
    ...
    <header>
	  ...
	  <nav>
	    <div id="menubar">
          <ul id="nav">
            <li class="current"><a href="#">Manager Home</a></li>
            <li><a href="installTruck.jsp">Home</a></li>
            <li><a href="searchManager.jsp">Search</a></li>
    ...
    <form action="ManagerDetails" method="post">
        ...
        <input type="submit" name="click me" value="Click Here"/>
    </form>
    </div>
