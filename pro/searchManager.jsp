<%-- 
    ...
    Created on : Jul 3, 2015, 12:48:28 AM
	  ...
	  <nav>
	    <div id="menubar">
          <ul id="nav">
            ...
            <li class="current"><a href="#">Search Manager</a></li>
        ...
        <div class="content_item">
		  <h1>MOST CONVENIENT AND RELIABLE TRANSPORT SYSTEM</h1> 
			...
			<p>Welcome To Our Truck Tracking Company</p>
                        ...
                        <pre id="new"><p><span>User Name:         </span><input class="contact" align="right" type="text" name="userName" value="" /></p></pre>
